...
<nav class="navbar navbar-expand-lg navbar-dark bg-success sticky-top">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"
			style="margin-top: -35px; margin-bottom: -25px;"><img
			style="height: 140px; width: 230px;" alt="img/medical.png"
			src="img/medical.png"> </a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${empty userObj }">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="userAppointment.jsp"><i
							class="fa-solid fa-phone"></i> APPOINTMENT</a></li>
					<li class="nav-item"><a class="nav-link active"
